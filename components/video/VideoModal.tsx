...
// Styles remain largely the same, but I've simplified a few parts
const styles = StyleSheet.create({
  ...
  video: {
    ...StyleSheet.absoluteFillObject, // Make video fill the container
  },
  loadingContainer: {
  ...
  infoSection: {
    ...
    marginTop: -16, // Overlap the video container slightly
  },
  videoTitle: {
    fontSize: 18,
    fontWeight: '600',
