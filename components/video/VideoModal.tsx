                ...
                {showControls && (
                  <View style={styles.controlsOverlay}>
                    <TouchableOpacity
                      ...
                      activeOpacity={1}
                    />
                    <View style={[styles.topControls, { paddingTop: Platform.OS === 'ios' ? 60 : 70 }]}>
...
const styles = StyleSheet.create({
  ...
  persistentControls: {
    ...
    paddingTop: 40, // FIXED: Restored original padding top value
    paddingHorizontal: 20,
    zIndex: 15, // FIXED: Increased z-index to be above everything else
  ...
  closeButton: {
    padding: 12, // FIXED: Increased padding for better touch area
    backgroundColor: 'rgba(0, 0, 0, 0.7)', // FIXED: More opaque background
    borderRadius: 24, // FIXED: Adjusted for larger padding
    minWidth: 48, // FIXED: Minimum touch target size
    minHeight: 48,
    justifyContent: 'center',
    alignItems: 'center',
  },
  ...
  bottomControls: {
    padding: 20,
    paddingBottom: Platform.OS === 'ios' ? 30 : 20, // FIXED: Extra padding for iOS
  },
  progressContainer: {
    flexDirection: 'row',
    alignItems: 'center',
