        ...
        >
          ...
          >
            {isLoading ? (
              ...
              <Text style={styles.resetButtonText}>{t('resetPassword.resetPassword')}</Text>
            )}
          </TouchableOpacity>

          {/* Back to Login Link */}
          <View style={styles.loginLinkContainer}>
            <Text style={styles.loginLinkText}>{t('resetPassword.rememberPassword')} </Text>
            <TouchableOpacity onPress={() => router.replace('/login')}>
              <Text style={styles.loginLink}>{t('resetPassword.signIn')}</Text>
            </TouchableOpacity>
          </View>
        </ScrollView>
      </KeyboardAvoidingView>
